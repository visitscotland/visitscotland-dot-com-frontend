...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 7924px, received 1280px by 7586px. 430317 pixels (ratio 0.05 of all image pixels) are different.
  - waiting 100ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - Expected an image 1280px by 7586px, received 1280px by 7924px. 429947 pixels (ratio 0.05 of all image pixels) are different.
