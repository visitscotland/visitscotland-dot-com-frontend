...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 16583px, received 1280px by 19395px. 2825971 pixels (ratio 0.12 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 16583px, received 1280px by 19395px. 2825943 pixels (ratio 0.12 of all image pixels) are different.
