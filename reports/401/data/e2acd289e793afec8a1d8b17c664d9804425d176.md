...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 7938px, received 1280px by 7924px. 599560 pixels (ratio 0.06 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 7938px, received 1280px by 7586px. 1012225 pixels (ratio 0.10 of all image pixels) are different.
