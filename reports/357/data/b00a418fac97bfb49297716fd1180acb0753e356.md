...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 7694px, received 1280px by 14132px. 4966649 pixels (ratio 0.28 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - Expected an image 1280px by 7694px, received 1280px by 14132px. 4966572 pixels (ratio 0.28 of all image pixels) are different.
